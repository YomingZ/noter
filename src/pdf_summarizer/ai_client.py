"""AI API client module supporting multiple providers with rate limiting and caching."""
...
from pdf_summarizer.models import AIProvider, AIConfig
...
class BaseAIClient(ABC):
    ...
    def generate(self, system_prompt: str, user_prompt: str) -> str:
        ...
        # Check cache first (may be None when cache is disabled)
